...
const Sidebar = ({ isOpen, setIsOpen }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar Content */}
      <div className={`fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto scrollbar-hide transition duration-300 transform bg-white border-r border-gray-200 text-gray-600 lg:translate-x-0 lg:static lg:inset-0 ${isOpen ? 'translate-x-0' : '-translate-x-full'} flex flex-col`}>
        <div className="flex items-center justify-between p-6 border-b border-gray-100">
          ...
          <button className="lg:hidden text-gray-400 hover:text-gray-600" onClick={() => setIsOpen(false)}>
            <FaTimes />
          </button>
        </div>
