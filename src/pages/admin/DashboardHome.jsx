    ...
    <div className="space-y-6 animate-fade-in-up">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
             <h2 className="text-lg font-bold text-gray-800 mb-4">Live Updates</h2>
             <div className="-mx-4 space-y-1">
                <ActivityItem title="New Application" desc="Sarah Juma applied for React." time="5m ago" />
                <ActivityItem title="Risk Alert" desc="Attendance warning: Class 4A" time="30m ago" type="alert" />
                <ActivityItem title="Payment Pending" desc="Invoice #402 Generated" time="1h ago" />
                <ActivityItem title="Donation" desc="$500 from Partner X" time="2h ago" />
             </div>
          </div>
      </div>
    </div>
